...
@section("title") Create your own Crossword{{ $crossword ? " - ".$crossword->id : '' }} - All Crossword @stop
...
@section("content")
	...
	{{ '<p>
		...
		{{ '<div id="layout" class="hide">' }} {{ $crossword ? htmlspecialchars($crossword->layout) : file_get_contents('layout.json') }} {{ '</div>' }}
